...
class MainActivity : AppCompatActivity() {
    ...
    private fun showRationalDialogForPermission(){
        AlertDialog.Builder(this).setMessage("It looks like you have turn off permission require for this feature,It can be enables under application Setting")
            ...
            listCall.enqueue(object :Callback<WeatherResponse> {
                ...
                override fun onResponse(response: Response<WeatherResponse>?, retrofit: Retrofit?) {
                    if (response!!.isSuccess) {
                        ...
                        val weatherResponseJasonString=Gson().toJson(weatherList)
                        val editor=mSharedPreferences.edit()
                        editor.putString(Constants.WEATHER_RESPONSE_DATA,weatherResponseJasonString)
                        editor.apply()
                        setUpUI()
    ...
    private fun showCustomDialogBox(){
      //  Toast.makeText(this@MainActivity,"In getLocationWeather",Toast.LENGTH_SHORT)
